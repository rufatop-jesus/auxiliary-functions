...
function [center2center, face2face] = calculateDistances(Lx,Ly,Lz,X,Y,Z,alpha,beta,gamma, rI, PB)
    nPart = size(X,1);
    center2center = c2cNearestNeighborMatrix(nPart,Lx,Ly,Lz,X,Y,Z);
    center2center = sort(center2center);

    % figure
    % plot(center2center, 0:1/(nPart-1):1)    

    face2face = f2fNearestNeighborMatrix(nPart,rI,PB,Lx,Ly,Lz,X,Y,Z,alpha,beta,gamma);
...
function center2center = c2cNearestNeighborMatrix(nPart,Lx,Ly,Lz,X,Y,Z)
    dMatrix = zeros(nPart);   
    for i = 1 : nPart
        for j = i + 1 : nPart
            
            % distance between particles i and j in the domain and in every
            % 26 periodic boundaries
            r = [sqrt(power(X(i)-X(j), 2) + power(Y(i)-Y(j), 2) + power(Z(i)-Z(j), 2));...

                 sqrt(power(X(i)-X(j)+Lx, 2) + power(Y(i)-Y(j), 2) + power(Z(i)-Z(j), 2));...
                 sqrt(power(X(i)-X(j)-Lx, 2) + power(Y(i)-Y(j), 2) + power(Z(i)-Z(j), 2));...

                 sqrt(power(X(i)-X(j), 2) + power(Y(i)-Y(j)+Ly, 2) + power(Z(i)-Z(j), 2));...
                 sqrt(power(X(i)-X(j), 2) + power(Y(i)-Y(j)-Ly, 2) + power(Z(i)-Z(j), 2));...

                 sqrt(power(X(i)-X(j), 2) + power(Y(i)-Y(j), 2) + power(Z(i)-Z(j)+Lz, 2));...
                 sqrt(power(X(i)-X(j), 2) + power(Y(i)-Y(j), 2) + power(Z(i)-Z(j)-Lz, 2));...

                 sqrt(power(X(i)-X(j)+Lx, 2) + power(Y(i)-Y(j)+Ly, 2) + power(Z(i)-Z(j), 2));...
                 sqrt(power(X(i)-X(j)+Lx, 2) + power(Y(i)-Y(j)-Ly, 2) + power(Z(i)-Z(j), 2));...
                 sqrt(power(X(i)-X(j)-Lx, 2) + power(Y(i)-Y(j)+Ly, 2) + power(Z(i)-Z(j), 2));...
                 sqrt(power(X(i)-X(j)-Lx, 2) + power(Y(i)-Y(j)-Ly, 2) + power(Z(i)-Z(j), 2));...

                 sqrt(power(X(i)-X(j)+Lx, 2) + power(Y(i)-Y(j), 2) + power(Z(i)-Z(j)+Lz, 2));...
                 sqrt(power(X(i)-X(j)+Lx, 2) + power(Y(i)-Y(j), 2) + power(Z(i)-Z(j)-Lz, 2));...
                 sqrt(power(X(i)-X(j)-Lx, 2) + power(Y(i)-Y(j), 2) + power(Z(i)-Z(j)+Lz, 2));...
                 sqrt(power(X(i)-X(j)-Lx, 2) + power(Y(i)-Y(j), 2) + power(Z(i)-Z(j)-Lz, 2));...

                 sqrt(power(X(i)-X(j), 2) + power(Y(i)-Y(j)+Ly, 2) + power(Z(i)-Z(j)+Lz, 2));...
                 sqrt(power(X(i)-X(j), 2) + power(Y(i)-Y(j)+Ly, 2) + power(Z(i)-Z(j)-Lz, 2));...
                 sqrt(power(X(i)-X(j), 2) + power(Y(i)-Y(j)-Ly, 2) + power(Z(i)-Z(j)+Lz, 2));...
                 sqrt(power(X(i)-X(j), 2) + power(Y(i)-Y(j)-Ly, 2) + power(Z(i)-Z(j)-Lz, 2));...

                 sqrt(power(X(i)-X(j)+Lx, 2) + power(Y(i)-Y(j)+Ly, 2) + power(Z(i)-Z(j)+Lz, 2));...
                 sqrt(power(X(i)-X(j)+Lx, 2) + power(Y(i)-Y(j)-Ly, 2) + power(Z(i)-Z(j)+Lz, 2));...
                 sqrt(power(X(i)-X(j)-Lx, 2) + power(Y(i)-Y(j)+Ly, 2) + power(Z(i)-Z(j)+Lz, 2));...
                 sqrt(power(X(i)-X(j)-Lx, 2) + power(Y(i)-Y(j)-Ly, 2) + power(Z(i)-Z(j)+Lz, 2));...
...
function face2face = f2fNearestNeighborMatrix(nPart,rI,PB,Lx,Ly,Lz,X,Y,Z,alpha,beta,gamma)
    dMatrix = zeros(nPart);   
    for i = 1 : nPart
        for j = (i + 1) : nPart
            ...
            r = [sqrt(power(X(j)-X(i), 2) + power(Y(j)-Y(i), 2) + power(Z(j)-Z(i), 2));...
                 ...
                 sqrt(power(X(j)-X(i)+Lx, 2) + power(Y(j)-Y(i), 2) + power(Z(j)-Z(i), 2));...
                 sqrt(power(X(j)-X(i)-Lx, 2) + power(Y(j)-Y(i), 2) + power(Z(j)-Z(i), 2));...

                 sqrt(power(X(j)-X(i), 2) + power(Y(j)-Y(i)+Ly, 2) + power(Z(j)-Z(i), 2));...
                 sqrt(power(X(j)-X(i), 2) + power(Y(j)-Y(i)-Ly, 2) + power(Z(j)-Z(i), 2));...

                 sqrt(power(X(j)-X(i), 2) + power(Y(j)-Y(i), 2) + power(Z(j)-Z(i)+Lz, 2));...
                 sqrt(power(X(j)-X(i), 2) + power(Y(j)-Y(i), 2) + power(Z(j)-Z(i)-Lz, 2));...

                 sqrt(power(X(j)-X(i)+Lx, 2) + power(Y(j)-Y(i)+Ly, 2) + power(Z(j)-Z(i), 2));...
                 sqrt(power(X(j)-X(i)+Lx, 2) + power(Y(j)-Y(i)-Ly, 2) + power(Z(j)-Z(i), 2));...
                 sqrt(power(X(j)-X(i)-Lx, 2) + power(Y(j)-Y(i)+Ly, 2) + power(Z(j)-Z(i), 2));...
                 sqrt(power(X(j)-X(i)-Lx, 2) + power(Y(j)-Y(i)-Ly, 2) + power(Z(j)-Z(i), 2));...

                 sqrt(power(X(j)-X(i)+Lx, 2) + power(Y(j)-Y(i), 2) + power(Z(j)-Z(i)+Lz, 2));...
                 sqrt(power(X(j)-X(i)+Lx, 2) + power(Y(j)-Y(i), 2) + power(Z(j)-Z(i)-Lz, 2));...
                 sqrt(power(X(j)-X(i)-Lx, 2) + power(Y(j)-Y(i), 2) + power(Z(j)-Z(i)+Lz, 2));...
                 sqrt(power(X(j)-X(i)-Lx, 2) + power(Y(j)-Y(i), 2) + power(Z(j)-Z(i)-Lz, 2));...

                 sqrt(power(X(j)-X(i), 2) + power(Y(j)-Y(i)+Ly, 2) + power(Z(j)-Z(i)+Lz, 2));...
                 sqrt(power(X(j)-X(i), 2) + power(Y(j)-Y(i)+Ly, 2) + power(Z(j)-Z(i)-Lz, 2));...
                 sqrt(power(X(j)-X(i), 2) + power(Y(j)-Y(i)-Ly, 2) + power(Z(j)-Z(i)+Lz, 2));...
                 sqrt(power(X(j)-X(i), 2) + power(Y(j)-Y(i)-Ly, 2) + power(Z(j)-Z(i)-Lz, 2));...

                 sqrt(power(X(j)-X(i)+Lx, 2) + power(Y(j)-Y(i)+Ly, 2) + power(Z(j)-Z(i)+Lz, 2));...
                 sqrt(power(X(j)-X(i)+Lx, 2) + power(Y(j)-Y(i)-Ly, 2) + power(Z(j)-Z(i)+Lz, 2));...
                 sqrt(power(X(j)-X(i)-Lx, 2) + power(Y(j)-Y(i)+Ly, 2) + power(Z(j)-Z(i)+Lz, 2));...
                 sqrt(power(X(j)-X(i)-Lx, 2) + power(Y(j)-Y(i)-Ly, 2) + power(Z(j)-Z(i)+Lz, 2));...
            ...
            posNearNeighbor = find(r == min(r));

            xyz = [X(j)-X(i), Y(j)-Y(i), Z(j)-Z(i);...

                   X(j)-X(i)+Lx, Y(j)-Y(i), Z(j)-Z(i);...
                   X(j)-X(i)-Lx, Y(j)-Y(i), Z(j)-Z(i);...

                   X(j)-X(i), Y(j)-Y(i)+Ly, Z(j)-Z(i);...
                   X(j)-X(i), Y(j)-Y(i)-Ly, Z(j)-Z(i);...

                   X(j)-X(i), Y(j)-Y(i), Z(j)-Z(i)+Lz;...
                   X(j)-X(i), Y(j)-Y(i), Z(j)-Z(i)-Lz;...

                   X(j)-X(i)+Lx, Y(j)-Y(i)+Ly, Z(j)-Z(i);...
                   X(j)-X(i)+Lx, Y(j)-Y(i)-Ly, Z(j)-Z(i);...
                   X(j)-X(i)-Lx, Y(j)-Y(i)+Ly, Z(j)-Z(i);...
                   X(j)-X(i)-Lx, Y(j)-Y(i)-Ly, Z(j)-Z(i);...

                   X(j)-X(i)+Lx, Y(j)-Y(i), Z(j)-Z(i)+Lz;...
                   X(j)-X(i)+Lx, Y(j)-Y(i), Z(j)-Z(i)-Lz;...
                   X(j)-X(i)-Lx, Y(j)-Y(i), Z(j)-Z(i)+Lz;...
                   X(j)-X(i)-Lx, Y(j)-Y(i), Z(j)-Z(i)-Lz;...
                   
                   X(j)-X(i), Y(j)-Y(i)+Ly, Z(j)-Z(i)+Lz;...
                   X(j)-X(i), Y(j)-Y(i)+Ly, Z(j)-Z(i)-Lz;...
                   X(j)-X(i), Y(j)-Y(i)-Ly, Z(j)-Z(i)+Lz;...
                   X(j)-X(i), Y(j)-Y(i)-Ly, Z(j)-Z(i)-Lz;...
                   
                   X(j)-X(i)+Lx, Y(j)-Y(i)+Ly, Z(j)-Z(i)+Lz;...
                   X(j)-X(i)+Lx, Y(j)-Y(i)-Ly, Z(j)-Z(i)+Lz;...
                   X(j)-X(i)-Lx, Y(j)-Y(i)+Ly, Z(j)-Z(i)+Lz;...
                   X(j)-X(i)-Lx, Y(j)-Y(i)-Ly, Z(j)-Z(i)+Lz;...
            ...
            c2cvector = [xyz(posNearNeighbor,1); xyz(posNearNeighbor,2); xyz(posNearNeighbor,3)];
